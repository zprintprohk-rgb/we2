...
export default function SoulmateChatPage() {
  ...
  return (
    <div className="relative mx-auto flex h-[calc(100vh-4rem)] max-w-2xl flex-col overflow-hidden bg-gradient-to-b from-[#1a0b2e] via-[#0f0524] to-[#0a0118] px-4 text-zinc-100">
